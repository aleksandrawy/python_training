...
from http_requests import check_internet_connection
import time
import random
...
def wait_until(condition, timeout=10, raise_exception=True, msg=""):
   ...
   # def check_connection():
    ...
    if raise_exception:
        return TimeoutError(f"{msg} after {timeout} sec")
    else:
        return False
...
wait_until(condition=check_internet_connection(), msg="No internet connection.")
